...
| 3 | Follow `docs/getting_started.md` — install Docker, Pixi, build evaluation container | All | ☐ |
...
## Phase 1: Baseline Development (Weeks 3–5)
...
## Phase 2: Optimization (Weeks 6–8)
...
## Phase 3: If Selected for Phase 1 (Weeks 9–16, ~May–June)
...
## Phase 4: If Selected for Phase 2 (Weeks 17–20, ~June–July)
...
*Last updated: March 3, 2026. Update this document weekly as deadlines are announced and priorities shift.*
